...
function Home() {
  ...
  return (
    <>
    <div
      className="bg-home-mobile md:bg-home-tablet lg:bg-home-desktop h-fit lg:h-screen bg-cover bg-no-repeat w-full flex"
    >
            ...
            <div className="w-full mx-auto text-white">
              <div className="flex flex-col lg:flex-row gap-16 lg:gap-[0%] sm:items-center">
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                  <p className="uppercase font-barlow text-[16px] md:text-[20px] lg:text-[28px] tracking-[4.75px] font-normal">
